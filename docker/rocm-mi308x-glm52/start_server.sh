...
#
# No code patches — relies on official sglang v0.5.14 HIP support.
...
#
# Usage:
#   docker run -d ... sglang-glm52-308x:latest
#   docker run -d ... -e PORT=30001 -e MODEL_PATH=/data/model/glm52-fp8 sglang-glm52-308x:latest
...
echo " Port:   $PORT"
echo " Image:  official mi30x (no patches)"
echo "============================================"
