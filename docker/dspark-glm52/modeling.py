...
class Glm5DSparkMLAAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # DSpark: use kv_b_proj to decompress k_nope_compressed into k_nope and v.
        # This is mathematically equivalent to the inference absorb mode:
        #   q_nope @ w_kc → q_absorbed(512), attn_output @ w_vc → v(256)
        # Training with kv_b_proj directly: k_nope(192), v(256) — same result.
        ...
        k_nope_4d = k_nope.transpose(1, 2)  # [bsz, num_heads, kv_len, qk_nope_head_dim]
        value_states = v.transpose(1, 2)    # [bsz, num_heads, kv_len, v_head_dim]
