#!/usr/bin/env bash
# Entrypoint for GLM-5.2-FP8 SGLang worker on AMD MI355X (0723 build).
#
...
#
# Usage:
#   docker run -d ... sglang-glm52-0723:latest
#   docker run -d ... -e PORT=30001 -e MODEL_PATH=/data/models/GLM-5.2-FP8 sglang-glm52-0723:latest
...
echo "============================================"
echo " GLM-5.2-FP8 SGLang Worker (0723-opt)"
echo "============================================"
echo " Model:  $MODEL_PATH"
echo " Port:   $PORT"
echo " Image:  pre-patched (no runtime patching)"
echo " AITER:  origin/main (upgraded from 9127c94a1)"
echo " Base:   v0.5.15.post1-rocm720-mi35x-20260722"
echo "============================================"
