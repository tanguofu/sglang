...
class DSparkWorkerV2(BaseSpecWorker):
    ...
    def _forward_prefill(
        ...
        # Preserve hidden_states when --enable-return-hidden-states is set.
        if not self.server_args.enable_return_hidden_states:
