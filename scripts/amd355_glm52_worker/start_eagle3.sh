...
CONTAINER_NAME="sglang_glm52_eagle3"
...
docker run -d \
  ...
  bash -c "
    ...
    exec python3 -m sglang.launch_server \
      ...
      --speculative-eagle-topk 2 --max-running-requests 128 --watchdog-timeout 3600 --log-level info
  "
echo "Container ${CONTAINER_NAME} started with EAGLE3 + SGLANG_DSA_FUSE_TOPK=false"
